...
type APIContainersArray []*APIContainers

func (this APIContainersArray) Len() int {
	return len(this)
}

func (this APIContainersArray) Less(i, j int) bool {
	return this[i].Created > this[j].Created
}

func (this APIContainersArray) Swap(i, j int) {
	this[i], this[j] = this[j], this[i]
}

func (c *DockerClient) ListContainers(opts ListContainersOptions) (APIContainersArray, error) {
	path := "/containers/json?" + queryString(opts)
	body, _, err := c.do("GET", path, nil)
	if err != nil {
		return nil, err
	}
	var containers APIContainersArray
...
func (c *DockerClient) InspectContainer(id string) (*Container, error) {
...
func (c *DockerClient) ContainerChanges(id string) ([]Change, error) {
...
func (c *DockerClient) CreateContainer(opts CreateContainerOptions) (*Container, error) {
...
func (c *DockerClient) StartContainer(id string, hostConfig *HostConfig) error {
	if hostConfig == nil {
		hostConfig = &HostConfig{}
	}
...
func (c *DockerClient) StopContainer(id string, timeout uint) error {
...
func (c *DockerClient) RestartContainer(id string, timeout uint) error {
...
func (c *DockerClient) KillContainer(id string) error {
...
func (c *DockerClient) RemoveContainer(opts RemoveContainerOptions) error {
...
//
// See http://goo.gl/mnxRMl for more details.
func (c *DockerClient) CopyFromContainer(opts CopyFromContainerOptions) error {
	if opts.Container == "" {
...
//
// See http://goo.gl/628gxm for more details.
func (c *DockerClient) CommitContainer(opts CommitContainerOptions) (*Image, error) {
...
//
// See http://goo.gl/oPzcqH for more details.
func (c *DockerClient) AttachToContainer(opts AttachToContainerOptions) error {
	if opts.Container == "" {
		return &NoSuchContainer{ID: opts.Container}
	}
...
func (c *DockerClient) ResizeContainerTTY(id string, height, width int) error {
...
//
// See http://goo.gl/Lqk0FZ for more details.
func (c *DockerClient) ExportContainer(opts ExportContainerOptions) error {
	if opts.ID == "" {
		return NoSuchContainer{ID: opts.ID}
	}
...
type PVMFlavor struct {
	Memory int64 `json:"memory"`
	Cpu    int64 `json:"cpu"`
	Disk   int64 `json:"disk"`
}

type PVMOptions struct {
	NetworkId string    `json:"network_id"`
	PvmFlavor PVMFlavor `json:"flavor"`
...
type CreatePVMOptions struct {
	Servers []PVMOptions `json:"servers"`
	Partial int          `json:"partial"`
}

type myRespone struct {
	Id      string `json:"request_id"`
	Code    string `json:"code"`
	Message string `json:"message"`
}

func (c *DockerClient) CreatePVM(opts CreatePVMOptions) error {
	body, _, err := c.do("POST", "/server", opts)
	if err != nil {
		return err
	}
	var response myRespone
